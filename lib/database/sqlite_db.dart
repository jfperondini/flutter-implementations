...
class SqliteDB {
  ...
  _onCreate(db, version) async {
    ...
    await db.execute(_sqlCreateTableAgenda);
  }
  ...
  String get agendaTableName => 'agenda';

  String get _sqlCreateTableAgenda => '''
        CREATE TABLE $agendaTableName (
          idAgenda INTEGER PRIMARY KEY AUTOINCREMENTE, 
          tituloEvento String, 
          dataEvento STRING, 
          horaInicial STRING, 
          horaFinal STRING, 
